...
_ROMAN_NUMERAL_RE = re.compile(
    r"^(?:i|ii|iii|iv|v|vi|vii|viii|ix|x|xi|xii|xiii|xiv|xv|xvi|xvii|xviii|xix|xx)$", re.IGNORECASE
)
...
def find_repeated_lines(
    ...
    return {
        line for line, hits in page_hits.items() if len(line) <= max_len and hits >= required_pages
    }
